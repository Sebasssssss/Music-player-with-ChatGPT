    ...
    <div {...props} className={className}>
      <div className="relative mt-4 flex-1 overflow-hidden rounded-lg border-none outline-none">
        <TextareaAutosize
          ...
          className="peer placeholder:text-zinc-700 placeholder:font-medium outline-none disabled:opacity-50 pr-14 resize-none block w-full border-0 py-1.5 text-gray-900 focus:ring-0 text-sm sm:leading-6"
        />
